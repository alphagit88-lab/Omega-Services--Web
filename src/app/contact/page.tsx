    ...
    <div className="bg-white">
      ...
      <section className="bg-gradient-to-br from-secondary via-gray-800 to-primary-dark border-b border-gray-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-sm font-bold tracking-wider text-red-300 uppercase mb-2 block">Get In Touch</span>
          <h1 className="text-4xl sm:text-5xl font-extrabold text-white tracking-tight mb-4">Contact Us</h1>
